...
## Resumo  
1. Este livro irá apresentar todas as rotinas utilizadas em estatística a partir de linhas de código do R.  
2. O ambiente de programação `tidyverse` servirá como base principal para programação.
3. Entre as principais vantagens do R, estão a gratuidade de seu acesso e uso
4. Entre as principais desvantagens do R, estão a necessidade de programação e algumas análises descritivas 
