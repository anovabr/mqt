...
Entre as maneiras desenvolvidas por cientistas para lidar com esta situação está a construção de modelos teóricos e instrumentos de medida. Modelos científicos são representações da realidade e podem ser criados sob perspectiva matemática, computacional ou experimental. Eles tendem a ser sistemas fechados e visam reproduzir, precisamente, o fenômeno ou objeto de interesse. A qualidade desses modelos pode variar e entre as principais características positivas de um modelo estão a sua aderência com a realidade e a possibilidade de realizar simulação com ele. Em um modelo ideal, aquilo que fosse descoberto a partir dele, ocorreria identicamente na realidade. Evidentemente, modelos ideais não existem na grande maioria das áreas científicas, o que leva à conclusão de que os modelos são absolutamente essenciais à pesquisa, apesar de possuírem limitações [@Putnam1980, @Feigelson1992, @Firgg2020]. A figura a seguir apresenta tais características.

![](./img/cap_modelos_cientificos.png) 

Por sua vez, os instrumentos de medida são recursos tecnológicos que permitem uma avaliação mais detalhada do fenômeno ou do objeto de investigação, bem como produzir dados que podem ser estudados, compartilhados e comparados. Com muita frequência, o registro que temos da realidade é baseado em nossos órgãos sensoriais que, por sua vez, são influenciados pela cultura em que estamos inseridos e pela aprendizagem prévia pela qual passamos.   
...
O segundo conceito se dá na dicotomia constante vs. variáveis. De fato, essa relação também poderia ser vista pela dicotomia entre modelo determinístico e modelo probabilístico. 

De maneira geral, um fenômeno constante não apresenta dispersão em seus valores. Por sua vez, fenômenos variáveis são aqueles que podem assumir quaisquer condições em suas características. Enquanto a velocidade da luz e do som é, respectivamente, XX e XX; a altura ou a inteligência das pessoas podem variar bastante. 
A noção de modelos determinísticos e probabilísticos é intimamente associada a estes conceitos. Modelos determinísticos são aqueles que ___. Por sua vez, modelos probabilísticos são aqueles que lidam com variáveis e, com frequência, visam investigar o relacionamento entre elas.
