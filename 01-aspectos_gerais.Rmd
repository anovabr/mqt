...
2. Discutir algumas características das variáveis     
...
Uma pesquisa é um procedimento racional e sistemático de investigação que visa proporcionar respostas específicas a um conjunto de problemas propostos [@gil2002]. A execução de uma pesquisa depende da eleição de problemas específicos, bem como da coleta e análise de dados. É possível classificar as pesquisas a partir de três grandes objetivos, que são as (1) pesquisas exploratórias, (2) pesquisas descritivas e (3) pesquisas explicativas. A tabela a seguir sintetiza as principais características de cada um desses tipos.    
