...
load("~/anovabr/mqt/bases/Base R - Pesquisa mapfre.RData")
...
Neste capítulo (e em alguns outros), vamos utilizar a pesquisa intitulada "Depression and Anxiety Symptoms in a Representative Sample of Undergraduate Students in Spain, Portugal, and Brazil", com previsão de publicação pela Revista Psicologia: Teoria e Pesquisa em 2020. Nessa pesquisa, sou o coautor e o pesquisador responsável para correspondência.
...
```{r base e pacotes, include = FALSE }

load(file="C:/Users/luisf/OneDrive/Documentos/anovabr/MQT/bases/R - Base ANOVA de medidas repetidas.RData")
library(tidyverse)
library(knitr) #tables and graphs
library(kableExtra) #tables with different styles
```
...
<!--chapter:end:09-qui_quadrado.Rmd-->
