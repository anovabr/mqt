...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(country }\OperatorTok{~}\StringTok{ }\NormalTok{bdi_sum }\OperatorTok{+}\StringTok{ }\NormalTok{bai_sum, }
                 \DataTypeTok{test =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ Dataset) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(sex }\OperatorTok{~}\StringTok{ }\NormalTok{bdi_sum }\OperatorTok{+}\StringTok{ }\NormalTok{bai_sum, }
                 \DataTypeTok{test =} \OtherTok{FALSE}\NormalTok{, }
                 \DataTypeTok{data =}\NormalTok{ Dataset) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(}\KeywordTok{interaction}\NormalTok{(sex ,country) }\OperatorTok{~}\StringTok{ }\NormalTok{bdi_sum }\OperatorTok{+}\StringTok{ }\NormalTok{bai_sum, }
                 \DataTypeTok{control=}\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby.control}\NormalTok{(}\DataTypeTok{test=}\OtherTok{FALSE}\NormalTok{, }
...
\StringTok{  }\KeywordTok{geom_text}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =}\NormalTok{ scales}\OperatorTok{::}\KeywordTok{percent}\NormalTok{(}\KeywordTok{round}\NormalTok{(pct,}\DecValTok{3}\NormalTok{))), }
...
\StringTok{  }\KeywordTok{stat_summary}\NormalTok{(}\DataTypeTok{geom=}\StringTok{"errorbar"}\NormalTok{, }\DataTypeTok{fun.data =}\NormalTok{ mean_se, }
               \DataTypeTok{position =} \KeywordTok{position_dodge}\NormalTok{(}\FloatTok{0.95}\NormalTok{), }\DataTypeTok{width =} \FloatTok{.5}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{y =}\NormalTok{ bai_sum, }
                \DataTypeTok{fill =} \KeywordTok{factor}\NormalTok{(curso_ou_ano), }
                \DataTypeTok{color =}\NormalTok{ sex, }\DataTypeTok{shape =}\NormalTok{ country)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_jitter}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{descr}\OperatorTok{::}\KeywordTok{CrossTable}\NormalTok{(ds_selected}\OperatorTok{$}\NormalTok{sex_male,ds_selected}\OperatorTok{$}\NormalTok{adhd_parent,}\DataTypeTok{chisq =}\NormalTok{ T)}\OperatorTok{$}\NormalTok{CST }\OperatorTok{%>%}
\StringTok{  }\NormalTok{pander}\OperatorTok{::}\KeywordTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{chisq.test}\NormalTok{(ds_selected}\OperatorTok{$}\NormalTok{sex_male,ds_selected}\OperatorTok{$}\NormalTok{adhd_parent, }\DataTypeTok{correct =}\NormalTok{ F) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pander}\NormalTok{(., }\DataTypeTok{split.table =} \OtherTok{Inf}\NormalTok{, }\DataTypeTok{caption =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(ds_selected}\OperatorTok{$}\NormalTok{sex_male,ds_selected}\OperatorTok{$}\NormalTok{adhd_parent) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{DescTools}\OperatorTok{::}\KeywordTok{Rev}\NormalTok{(.) }\OperatorTok{%>%}\StringTok{ }
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{total_12 =} \KeywordTok{rowSums}\NormalTok{(}\KeywordTok{select}\NormalTok{(., }\KeywordTok{starts_with}\NormalTok{(}\StringTok{"q_"}\NormalTok{)), }
                            \DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}

\NormalTok{asq_18months <-}\StringTok{ }\NormalTok{asq_18months }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{total_18 =} \KeywordTok{rowSums}\NormalTok{(}\KeywordTok{select}\NormalTok{(., }\KeywordTok{starts_with}\NormalTok{(}\StringTok{"q_"}\NormalTok{)), }
                            \DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarise_at}\NormalTok{(}\KeywordTok{vars}\NormalTok{(total_}\DecValTok{12}\NormalTok{), }\KeywordTok{lst}\NormalTok{(}\DataTypeTok{n=}\OperatorTok{~}\KeywordTok{n}\NormalTok{(),}\DataTypeTok{media=}\NormalTok{mean, }\DataTypeTok{DP=}\NormalTok{sd)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(sex) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{shapiro =} \KeywordTok{shapiro.test}\NormalTok{(total_}\DecValTok{12}\NormalTok{)}\OperatorTok{$}\NormalTok{p.value) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{pander}\OperatorTok{::}\KeywordTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{car}\OperatorTok{::}\KeywordTok{leveneTest}\NormalTok{(total_}\DecValTok{12} \OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data =}\NormalTok{ asq_12months) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{pander}\OperatorTok{::}\KeywordTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(sex) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarise_at}\NormalTok{(}\KeywordTok{vars}\NormalTok{(total_}\DecValTok{18}\NormalTok{), }\KeywordTok{lst}\NormalTok{(}\DataTypeTok{n=}\OperatorTok{~}\KeywordTok{n}\NormalTok{(),}\DataTypeTok{media=}\NormalTok{mean, }\DataTypeTok{DP=}\NormalTok{sd)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{t_test_18m <-}\StringTok{ }\KeywordTok{t.test}\NormalTok{(total_}\DecValTok{18} \OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{var.equal =}\NormalTok{ T,}
                     \DataTypeTok{data =}\NormalTok{ asq_18months)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coin}\OperatorTok{::}\KeywordTok{statistic}\NormalTok{(coin}\OperatorTok{::}\KeywordTok{wilcox_test}\NormalTok{(total_}\DecValTok{18} \OperatorTok{~}\StringTok{ }\NormalTok{sex, }
                                  \DataTypeTok{data =}\NormalTok{ asq_18months))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(grupo }\OperatorTok{<}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{grupo =} \KeywordTok{factor}\NormalTok{(}
    \KeywordTok{if_else}\NormalTok{(grupo }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"Placebo"}\NormalTok{, }\StringTok{"Experimental"}\NormalTok{))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempo =} \KeywordTok{factor}\NormalTok{(}\KeywordTok{case_when}\NormalTok{(}
\NormalTok{    tempo }\OperatorTok{==}\StringTok{ "total_w4"} \OperatorTok{~}\StringTok{ "antes"}\NormalTok{,}
\NormalTok{    tempo }\OperatorTok{==}\StringTok{ "total_w0"} \OperatorTok{~}\StringTok{ "no_dia"}\NormalTok{,}
\NormalTok{    tempo }\OperatorTok{==}\StringTok{ "total_s2"} \OperatorTok{~}\StringTok{ "semana_2"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(tempo }\OperatorTok{~}\StringTok{ }\NormalTok{resultado }\OperatorTok{+}\StringTok{ }\NormalTok{grupo, }
                 \DataTypeTok{test =} \OtherTok{FALSE}\NormalTok{,tratamento) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(}\OperatorTok{~}\NormalTok{eat_soma }\OperatorTok{+}\StringTok{ }\NormalTok{bsq_soma, }
                 \DataTypeTok{test =} \OtherTok{FALSE}\NormalTok{, dados_brasil) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(}\OperatorTok{~}\NormalTok{eat_soma }\OperatorTok{+}\StringTok{ }\NormalTok{bsq_soma, dados_brasil) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor.test}\NormalTok{(dados_brasil}\OperatorTok{$}\NormalTok{eat_soma, dados_brasil}\OperatorTok{$}\NormalTok{bsq_soma) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pander}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arsenal}\OperatorTok{::}\KeywordTok{tableby}\NormalTok{(}\OperatorTok{~}\NormalTok{eat_soma }\OperatorTok{+}\StringTok{ }\NormalTok{bsq_soma }\OperatorTok{+}\StringTok{ }\NormalTok{imc, dados_brasil) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{predict}\NormalTok{(mod_linear_multiplo, }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{bsq_soma=}\KeywordTok{c}\NormalTok{(}\DecValTok{45}\NormalTok{), }
...
\StringTok{                   }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{  }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{ses }\OperatorTok{+}\StringTok{ }\NormalTok{sleeping }\OperatorTok{+}\StringTok{ }\NormalTok{premature }\OperatorTok{+}\StringTok{ }
\StringTok{                   }\NormalTok{smoking }\OperatorTok{+}\StringTok{ }\NormalTok{alcohol }\OperatorTok{+}\StringTok{ }\NormalTok{sdq_risk, }
                 \DataTypeTok{test =} \OtherTok{FALSE}\NormalTok{,}
...
\StringTok{                   }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{  }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{ses }\OperatorTok{+}\StringTok{ }\NormalTok{sleeping }\OperatorTok{+}\StringTok{ }\NormalTok{premature }\OperatorTok{+}
\StringTok{                   }\NormalTok{smoking }\OperatorTok{+}\StringTok{ }\NormalTok{alcohol }\OperatorTok{+}\StringTok{ }\NormalTok{sdq_risk, }
                 \DataTypeTok{family =} \StringTok{"binomial"}\NormalTok{, }
                 \DataTypeTok{data =}\NormalTok{ base_uso)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{across}\NormalTok{(}\KeywordTok{c}\NormalTok{(age,race,sex,ses,sleeping,premature,}
\NormalTok{                  smoking,alcohol,sdq_risk), }\OperatorTok{~!}\KeywordTok{is.na}\NormalTok{(.x))) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{base_uso }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{risk =} 
           \KeywordTok{if_else}\NormalTok{(risk_cefaleia_resources }\OperatorTok{==}\StringTok{ "0"}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{#nuneric for poisson }
