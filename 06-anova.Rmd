...
`iid`ainda signica erros descorrelatados \[ COV(\epsilon_i,\epsilon_j)=0 \].  

É importante atentar que assumir média 0,  também implica que a correlação do erro com as variáveis é nula. Operacionalmente, o erro representa <u>todos os fatores de pesquisa</u> e problemas de medição que afetam o resultado além das variáveis independentes consideradas na modelagem.
