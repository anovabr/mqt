...
Em seguida, a análise gráfica pode ser realizada.
...
Tal como previamente exposto no teste T, gráficos e testes formais são muito úteis para verificar ambos os casos e vamos começar pela normalidade.
...
E o teste formal pode ser feito via `shapiro wilk`. Lembre-se que a $H_0$ desse teste assume normalidade e, idealmente, não deve ser rejeitada.
